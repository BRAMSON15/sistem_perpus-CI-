                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                            ...
                            <?php if (!empty($all_notifications)): ?>
                                <div style="display: flex; gap: 10px;">
                                    <button id="pageMarkRead" class="btn-primary-modern" style="padding: 8px 15px; font-size: 0.85rem;">Tandai Semua Dibaca</button>
                                    <button id="pageClearAll" class="btn-danger-modern" style="padding: 8px 15px; font-size: 0.85rem;">Hapus Semua</button>
                                </div>
                            <?php endif; ?>
                        </div>
